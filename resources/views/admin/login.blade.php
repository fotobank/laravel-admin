...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ admin_url('auth/login') }}" method="post">
        ...
        @if($errors->has('username'))
          @foreach($errors->get('username') as $message)
            <label class="control-label" for="inputError">
              <i class="fa fa-times-circle-o"></i>{{$message}}</label><br>
          @endforeach
        @endif
      ...
      <div class="form-group has-feedback" style="width:130px; height:46px;">
      ...
      <div class="form-group has-feedback {!! !$errors->has('csrf') ?: 'has-error' !!}">
      @if($errors->has('csrf'))
        @foreach($errors->get('csrf') as $message)
          <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i>{{$message}}</label><br>
        @endforeach
      @endif
      </div>
